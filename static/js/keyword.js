$(function () {
  ...
  var search_types = [
    ...
    { url: 'https://www.xiaobaipan.com/list-', type: 'wangpan' },// +encodeURIComponent(word)+.html?from=1
  ];
  ...
  $('#search_submit').on('click', function () {
    ...
    if (baseUrl && keyword) {
      if (type === 'wangpan') {
        window.open(baseUrl.url + encodeURIComponent(keyword) + '.html?from=1');
      } else {
  ...
  function openSearch(keyword) {
    ...
    if (baseUrl && keyword) {
      if (type === 'wangpan') {
        window.open(baseUrl.url + encodeURIComponent(keyword) + '.html?from=1', keyword);
      } else {
